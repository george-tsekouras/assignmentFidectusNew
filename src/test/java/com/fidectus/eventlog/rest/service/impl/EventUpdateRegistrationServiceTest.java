...
public class EventUpdateRegistrationServiceTest {
    ...
    public void save_userExists_withLastEventRegistration() {
        eventUpdateRegistrationService.save(eventLog);
    ...
    public void validate_userNotExists_shouldThrowIllegalArgumentException() {
        ...
        assertThrows(IllegalArgumentException.class,() -> eventUpdateRegistrationService.save(eventLog));
    }
